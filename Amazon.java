...
public class Amazon {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.get("https://www.amazon.in/Apple-iPhone-Pro-Max-128GB/");
        ...
        WebElement phone = driver.findElement(By.xpath("//span[text()='iphone 13 pro max (Sierra Blue,128GB Storage)']"));
        phone.click();
        ...
        File destination = new File ("./iphone.png");
